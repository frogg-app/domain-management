...
function NavContent({ pathname, onNavigate }: NavContentProps) {
  return (
    <>
      {/* Logo */}
      <div className="flex h-16 items-center gap-3 px-6 border-b border-gray-800/50">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-600">
          <ServerCog className="h-5 w-5 text-white" />
        </div>
        <div>
          <h1 className="text-base font-semibold text-white">Domain Manager</h1>
        </div>
      </div>
    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex h-14 items-center justify-between border-b border-gray-200 bg-white px-4 lg:hidden dark:border-gray-800 dark:bg-gray-950">
        <div className="flex items-center gap-3">
          ...
          <span className="font-semibold text-gray-900 dark:text-white">Domain Manager</span>
        </div>
        <button
